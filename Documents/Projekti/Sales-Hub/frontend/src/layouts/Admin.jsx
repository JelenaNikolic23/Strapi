...
class Dashboard extends React.Component {
        ...
        {routes.map((prop, key) => {
          ...
          return (
            ...
            <Route
              ...
              key={key}
              render={(props) => (
                <prop.component {...props} scrollToTop={this.scrollToTop} />
              )}
            />
          );
          // }
  ...
  componentDidMount() {
    ...
    // set user role
    const userRole = localStorage.getItem("elearningrole");
    this.setState({ userRole: parseInt(userRole) });
  ...
  render() {
    ...
    return (
      <div className={classes.wrapper}>
        <Sidebar
          routes={this.state.userRole > 1 ? routes : []}
          logoText={"Sales Box"}
          logo={logo}
