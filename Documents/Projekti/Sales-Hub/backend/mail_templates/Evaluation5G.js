...
const evaluationSavedMail = evaluation => {
  ...
  transporter.sendMail(
    {
      ...
      subject: "Sales Box - Nova 5G ocena",
  ...
  transporter.sendMail(
    {
      ...
      subject: "Sales Box - 5G Odgovor prodavca na evaluaciju",
      html: `<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
              <html lang="en">
              <head>
                <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
module.exports.evaluationSavedMail = evaluationSavedMail;
